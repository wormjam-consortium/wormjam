    ...
    "embeds": [
        {
            ...
            "color": 10027008,
            "description": "A build has failed from [%s](%s)"
            % (TRAVIS_REPO_SLUG, "https://github.com/" + TRAVIS_REPO_SLUG),
            "fields": [
                {"name": "Build Number", "value": str(TRAVIS_BUILD_NUMBER)},
                {
                    "name": "Build logs",
                    "value": "Logs can be found [here](" + TRAVIS_BUILD_WEB_URL + ")",
                },
            ],
            "thumbnail": {"url": "https://travis-ci.com/images/logos/Tessa-1.png"},
